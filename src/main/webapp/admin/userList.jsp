        ...
        <c:forEach items="${data}" var="v">
            <tr>
                ...
                <td style="width: 180px;">
                    <a href="userEdit?userid=${v.userid}" class="layui-btn layui-btn layui-btn-sm">修改</a>

                    <a href="userDelete?userid=${v.userid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>

                    <btn path="userDetail?userid=${v.userid}"
    ...
    layui.use(['element', 'layer', 'jquery', 'form'], function () {
        ...
        $(".showDetail").click(function () {
            ...
            layer.open({
                ...
                title: '用户信息详情查看',
                anim: 2,    //弹出窗口使用的动画
                area: ['500px', '380px'],  //设置弹出窗口的大小 宽度,高度
