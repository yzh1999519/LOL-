    ...
    <table class="layui-table">
        ...
        <c:forEach items="${data}" var="v">
            <tr>
                <td>${v.heroid}</td>
                <td>${v.heroname}</td>
                <td>${v.heroorientation}</td>
                <td>${v.countryid}</td>
                <td>${v.countryname}</td>

                <td style="width: 180px;">
                    <a href="heroEdit?heroid=${v.heroid}" class="layui-btn layui-btn layui-btn-sm">修改</a>

                    <a href="heroDelete?heroid=${v.heroid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>

                    <btn path="heroDetail?heroid=${v.heroid}"
