    ...
    <table class="layui-table">
        ...
        <c:forEach items="${data}" var="v">
            <tr>
                <td>${v.countryid}</td>
                <td>${v.countryname}</td>
                <td>${v.countryenvironment}</td>

                <td style="width: 180px;">
                    <a href="countryEdit?countryid=${v.countryid}" class="layui-btn layui-btn layui-btn-sm">修改</a>

                    <a href="countryDelete?countryid=${v.countryid}"
                       class="layui-btn layui-btn-danger layui-btn-sm">删除</a>

                    <btn path="countryDetail?countryid=${v.countryid}"
